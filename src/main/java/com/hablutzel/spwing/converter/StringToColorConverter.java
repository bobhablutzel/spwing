...
public class StringToColorConverter implements Converter<String, Color> {
    ...
    /**
     * The Map of string to colors
     */
    public static final Map<String, Color> htmlColors;

    /*
     * Populate the HTML colors
     */
    static {
    ...
    public Color convert(@NonNull final String colorName) {
        return htmlColors.getOrDefault(colorName, Color.black);
    }
}
